...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		// if (Session["admin0123698745"] == null) { Response.Redirect("/Admin/Login", true); }
		// return (Session["DUser"] != null);
        HttpCookie getCookie = HttpContext.Current.Request.Cookies["DUser"];
