...
namespace DreamCMS.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Index(int id)
        {
            ...
            List<Product> ListProduct = db.Products.Where(x => x.IsDisable == false && x.GroupProductId == id).OrderByDescending(x => x.Order).ToList();
        ...
        public ActionResult ViewGroup(string titleidgroup, int? page)
        {
            ...
            if (ListProduct == null) { ListProduct = new List<Product>(); }
            return View(ListProduct.ToPagedList(currentPageIndex, 30));
        }
